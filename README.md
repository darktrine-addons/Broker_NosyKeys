...
See [CHANGELOG.md](https://github.com/darktrine-addons/Broker_NosyKeys/blob/main/CHANGELOG.md) for the full version history. The notes for each release are also posted with the download on CurseForge and Wago.
